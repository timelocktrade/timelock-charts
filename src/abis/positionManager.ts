export const positionManagerAbi = [
  {
    ...
    outputs: [{name: 'sharesBurned', type: 'uint256', internalType: 'uint256'}],
  ...
  {
    type: 'error',
    name: 'TimelockV2PositionManager__NotWhitelistedApp',
    inputs: [],
  },
  {
    type: 'error',
    name: 'TimelockV2PositionManager__NotWhitelistedHandler',
    inputs: [],
  },
] as const;
